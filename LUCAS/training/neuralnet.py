...
from notebooks.experiments import exp4_data_feature_extraction as exp4
from keras import regularizers
import gensim
from gensim.models import KeyedVectors
from scripts.training_helpers import pickle_model

all_reviews, fake_reviews, genuine_reviews, unused_genuine_reviews = exp4.get_balanced_dataset()
...
wv = KeyedVectors.load('../wordvec/yelp_w2v.kv')
...
for train, test in kfold.split(X, y):
    ...
    model.compile(optimizer='adam',
              ...
              metrics=['accuracy'])
    model.fit(X[train], y[train], epochs=30, batch_size=16, validation_split=0.3, verbose=1, callbacks=[early_stop])
...
# scores = final_model.evaluate(final_test_x, final_test_y, verbose=2)
# print(scores)
